    ...
    */
    ...
    public function verification($token) {
        ...
        if(isset($verify)) {
            ...
            return redirect('/login')->with('warning', 'Sorry, your eamil is not identified');
        }
    ...
    protected function registered(Request $request, $user) {
        $this->guard()->logout();
        return redirect('/login')->with('success', 'We sent you an activation code. Check your email and click the link to verify');
    }
}
